// server/kernels/best_first.js — 最佳优先贪心
import { heur, NEI4 } from '../util.js';
export function best_first(ctx, rng, params) {
...
best_first.__meta = { id: 'best_first', branch: 'graph_search', hardLimits: { iter: 1024 }, fallback: 'noop' };